...
export default function AddressForm() {
  ...
  return (
    <React.Fragment>
      <form>
        <Box height={25} />
        <Typography variant="h3" color="primary" align="center" fontFamily="">
          New Project
        </Typography>
        <Paper elevation={3} sx={{ marginLeft: "15%", marginRight: "15%", marginTop: '1%', backgroundColor: "gray", boxShadow: "10px 10px 10px 10px gray", height: '600px' }}>
          <Box sx={{ padding: 5 }}>
            ...
            />
              ...
              <Grid item xs={12} sm={4}>
                <Button variant="contained" sx={{ color: "white",backgroundColor:"black" }} onClick={handleSubmit}>
                  Save
                </Button>
              </Grid>
              <Grid item xs={12} sm={5} />
